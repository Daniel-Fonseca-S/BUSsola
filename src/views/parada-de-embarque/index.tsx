			...
			<View style={styles.content}>
				...
				<View style={styles.content}>
					...
					<ScrollView style={{margin: 20, maxHeight: 300}}>
						<Text>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc euismod massa felis, sed luctus elit venenatis at. Cras sodales nunc in dolor gravida, id suscipit lacus lobortis. 
